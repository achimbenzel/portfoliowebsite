...
/* ===== SERVICE CATEGORY PAGE (/branding, /motion-design, /web-design) =====
   Intro -> what's included -> how it runs -> what you get -> FAQ -> related
   work. No imagery: the sections are built from components that already exist
   elsewhere on the site (.services-grid cards, the about page's journey
   timeline, the FAQ accordion, the project grid). */
