...
app.get('/', (req, res) => {
  // If user has a ?lang= param, use that (for the language toggle)
...
<title>${pageTitle} — Achim Benzel</title>
<link rel="icon" type="image/svg+xml" href="/Assets/logo.svg"/>
<link rel="alternate" hreflang="en" href="/en${pathAfterLang}"/>
<link rel="alternate" hreflang="de" href="/de${pathAfterLang}"/>
<link rel="alternate" hreflang="x-default" href="/en${pathAfterLang}"/>
